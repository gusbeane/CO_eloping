...
fig, ax, _ = corner_plot(1, np.array([1, 2, 3]), np.array([1, 1, 1]), cosmo, 0.4, kmax=1, Vk=20, norm=True, intstr=True)
fig.tight_layout()
fig.savefig('corner_Nconstant.pdf')

fig, ax, _ = corner_plot(1, np.array([2, 2, 2]), np.array([1, 2, 3]), cosmo, 0.4, kmax=1, Vk=20, norm=True, intstr=True)
fig.tight_layout()
