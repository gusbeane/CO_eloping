...
\section{CO Modelling} \label{sec:co_modelling}
To model the statistical fluctuation and amplitude of the CO intensity maps we
follow \citet{2016ApJ...825..143L}, and briefly summarize the procedure here.
We begin by assuming a Schechter form for the star formation rate function,
...
$\epsilon_l$ is the comoving emissivity, each of line $l$. 
